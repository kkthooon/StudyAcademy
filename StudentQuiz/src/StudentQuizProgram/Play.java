...
public class Play extends StudentManagement {
	...
	public void showResult(){
		File outFile = new File("C:\\Users\\green201-11\\eclipse-workspace\\StudentQuiz", "Result.txt");
		//==========================//
		// 텍스트 파일 쓰기
		//==========================//
		...
		try {
			...
			//bw.write(loginStudent.getName() + "님의 성적");
			bw.newLine();
